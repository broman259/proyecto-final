                            ...
                            <x-dropdown align="left" width="48">
                                ...
                                <x-slot name="content">
                                    <div class="block px-4 py-2 text-xs text-gray-400">
                                        {{ __('Listado General de Jugadores') }}
                                    </div>

                                    <x-dropdown-link href="{{ route('reportes.jugadoresGeneral') }}">
                                        {{ __('Jugadores General') }}
                                    </x-dropdown-link>
                                    ...
                                    <x-dropdown-link href="{{ route('reportes.jugadoresEquipo') }}">
                                        {{ __('Jugadores x Equipo') }}
                                    </x-dropdown-link>

                                    <x-dropdown-link href="{{ route('reportes.equipos') }}">
                                        {{ __('Equipos') }}
                                    </x-dropdown-link>
                                    ...
                                    <div class="block px-4 py-2 text-xs text-gray-400">
                                        {{ __('Máximos Anotadores') }}
                                    </div>

                                    <x-dropdown-link href="{{ route('reportes.maximosAnotadores') }}">
                                        {{ __('Todos los Anotadores') }}
                                    </x-dropdown-link>
