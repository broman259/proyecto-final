                ...
                <form action="{{ route('equipos.update', $equipo->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div class="grid grid-cols-1">
                            ...
                            <input name="nombre" value="{{ $equipo->nombre }}" class="py-2 px-3 rounded-lg border-2 border-slate-300 mt-1 focus:outline-none focus:ring-2 focus:ring-slate-600 focus:border-transparent" type="text" required />
                        </div>
                    </div>

                    <!-- Para ver la imagen seleccionada -->
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        <img src="/imagen/{{ $equipo->imagen }}" id="imagenSeleccionada" style="max-height: 200px;">
                    </div>
